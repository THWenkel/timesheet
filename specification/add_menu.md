# Add Menu System to Timesheet Application
...
- **Timesheet** (top-level menu)
  ...
  - **Projects** (links to the project management page), provide only the menu item, will be added in a future feature, see [add_project_feature.md](add_project_feature.md)
